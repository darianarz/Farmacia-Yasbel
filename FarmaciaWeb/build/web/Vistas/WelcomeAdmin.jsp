<%-- 
    ...
    Created on : 29/08/2024, 10:02:42 AM
    Author     : SENA
--%>
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="col-md-9 main-content">
                ...
                <main class="main">
                    <h1 style="display: flex; text-align: center; justify-content: center; align-items: center; font-family: 'New York', serif; font-size: 60px;">¡Bienvenido, Administrador!</h1>
                    ...
                    <h1 style="display: flex; text-align: center; justify-content: center; align-items: center; font-family: 'New York', serif; font-size: 60px;">Farmacia Yasbel</h1>
                </main>
            </div>
        </div>
    </div>
