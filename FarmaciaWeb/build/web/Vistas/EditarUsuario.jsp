<%-- 
    ...
    Created on : 12/09/2024, 12:32:09 PM
    Author     : HPLAPTOP01
--%>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-9 main-content">
                    ...
                    <form class="form-sing" action="/FarmaciaWeb/CtrUsuarioCre?accion=actualizarusu" method="POST" >

                        <div class="form-row">
                            <div class="col-6">
                                <label>Nombre</label> 
                                <input type="hidden" class="form-control" name="txtid" id="txtid" value="${usuarios.getUsuId()}"> 
                                <input type="text" class="form-control" name="txtnombre" placeholder="nombre" required="" value="${usuarios.getUsunombre()}">
                            </div>
                            <div class="col-6">
                                <label>Correo</label> 
                                <input type="email" class="form-control" name="txtcorreo" placeholder="correo" required="" value="${usuarios.getUsucorreo()}">
                            </div>
                            <div class="col-6">
                                <label>Direccion</label> 
                                <input type="text" class="form-control" name="txtdireccion" placeholder="direccion" required="" value="${usuarios.getUsudireccion()}">
                            </div>
                            <div class="col-6">
                                <label>Telefono</label> 
                                <input type="number" class="form-control" name="txttelefono" placeholder="telefono" required="" value="${usuarios.getUsutelefono()}">
                            </div>
                        </div>    

                        <button type="submit" name="accion" value="editarusuario" class="button">Enviar</button>
