<%-- 
    ...
    Created on : 16/09/2024, 12:56:30 AM
    Author     : HOME
--%>
            ...
            <div class="col-md-6 form-container">
                ...
                <form action="/FarmaciaWeb/CtrUsuarioCre?accion=actualizarUsuario" method="get">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="usuario" name="usuario" value="${usuario.getUsuusuario()}" class="form-control">
                    </div>
                    <div class="mb-3">
                        <label for="nombre" class="form-label">Nombre</label>
                        <input type="text" id="nombre" name="nombre" value="${usuario.getUsunombre()}" class="form-control">
                    </div>
                    <div class="mb-3">
                        <label for="apellido" class="form-label">Apellido</label>
                        <input type="text" id="apellido" name="apellido" value="${usuario.getUsuapellido()}" class="form-control">
                    </div>
                    <div class="mb-3">
                        <label for="correo" class="form-label">Correo</label>
                        <input type="email" id="correo" name="correo" value="${usuario.getUsucorreo()}" class="form-control">
                    </div>
                    <div class="mb-3">
                        <label for="telefono" class="form-label">Teléfono</label>
                        <input type="text" id="telefono" name="telefono" value="${usuario.getUsutelefono()}" class="form-control">
                    </div>
                    <div class="mb-3">
                        <label for="direccion" class="form-label">Dirección</label>
                        <input type="text" id="direccion" name="direccion" value="${usuario.getUsudireccion()}" class="form-control">
                    </div>
                    <button type="submit" class="btn btn-primary w-100" name="accion" value="actualizarUsuario">Actualizar</button>
                </form>
