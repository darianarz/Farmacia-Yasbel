...
<body>
                ...
                <nav class="nav">
                    ...
                    <div class="collapsible">
                        ...
                        <div class="collapsible-content">
                            ...
                            <a href="ListarProductoAdm.jsp" class="collapsible-link submenu-btn">Gestión de Productos</a>
                ...
                <main class="main">
                    <div class="container">
                        ...
                        <div class="grid">
                            ...
                            <!-- Aquí va la tabla o lista de productos, si la tienes -->
                        </div>
                    </div> 
                </main>
            </div>
    ...
    <script src="/FarmaciaWeb/JS/IndexAdmin.js"></script>
</body>
</html>
